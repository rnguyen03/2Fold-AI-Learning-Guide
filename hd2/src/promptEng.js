...
const finalizePrompt = async (message) => {
  try {
    ...
    let prompt = "You will learn about the knowledge structure of the user. Based on this, try to construct a reasonable way to respond to the request of the user outlined as the last task. Do not explicitly mention the database, but you may integrate them into your response.\n";
